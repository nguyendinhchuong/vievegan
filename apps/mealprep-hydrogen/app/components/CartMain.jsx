 ...
 * @return {import("/Users/jhdev/Pets/freelance/le/.worktrees/meal-prep-shopify-hydrogen/apps/mealprep-hydrogen/app/components/CartMain").LineItemChildrenMap}
 */
...
function CartEmpty({hidden = false}) {
  ...
  return (
    <div hidden={hidden} className="cart-empty">
      <p>Your cart is empty — add a meal to get started.</p>
      <Link
        to="/collections"
